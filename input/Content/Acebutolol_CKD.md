With the drug-specific parameters fixed, the healthy PBPK model was translated to a CKD PBPK model by adapting the healthy population to a population with CKD according to the defined method. 
